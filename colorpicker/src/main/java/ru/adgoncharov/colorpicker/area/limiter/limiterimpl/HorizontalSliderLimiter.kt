...
/**
 * Реализация [Limiter] для горизонтальных слайдеров.
 *
 * Ограничивает движение указателя строго по горизонтальной оси.
 * Значение Y всегда фиксируется по центру высоты области.
 */
